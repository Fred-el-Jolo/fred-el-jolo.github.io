...
Download https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/FiraCode/Regular/complete/Fira%20Code%20Regular%20Nerd%20Font%20Complete.otf
Double clic it to install it

- Setup terminal font (Firacode Nerd Font Regular - 12pt)

### solarized & dircolors [Make Linux terminal great again](https://maxim-danilov.github.io/make-linux-terminal-great-again/)
```sh
